...
namespace Aqueduct.Toggles.Tests.Helpers
{
    ...
    public class SerializationHelpersTests
    {
        ...
        {
            var test =
                "<SerializationHelpersTests.TestObject xmlns=\"http://schemas.datacontract.org/2004/07/Aqueduct.Toggles.Tests.Helpers\" xmlns:i=\"http://www.w3.org/2001/XMLSchema-instance\"><ThisShouldBeSerialized>test3</ThisShouldBeSerialized></SerializationHelpersTests.TestObject>";
